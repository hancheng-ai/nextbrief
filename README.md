...
[![Release](https://img.shields.io/badge/release-v0.1.0rc9-blue)](https://github.com/hancheng-ai/nextbrief/releases/tag/v0.1.0rc9)
[![TestPyPI](https://img.shields.io/badge/TestPyPI-0.1.0rc9-blue)](https://test.pypi.org/project/nextbrief/)
...
> **The current release is `0.1.0rc9`, and it is a prerelease.** It lives on
...
```sh
uvx --default-index https://test.pypi.org/simple/ "nextbrief==0.1.0rc9" v0
```
...
```sh
curl -fsSLO https://github.com/hancheng-ai/nextbrief/releases/download/v0.1.0rc9/nextbrief.pyz
...
```sh
curl -fsSLO https://github.com/hancheng-ai/nextbrief/releases/download/v0.1.0rc9/SHA256SUMS
...
pipx install --python /usr/bin/python3 \
  --index-url https://test.pypi.org/simple/ "nextbrief==0.1.0rc9"

uv tool install --python /usr/bin/python3 \
  --default-index https://test.pypi.org/simple/ "nextbrief==0.1.0rc9"
...
`v0.1.0rc9` sdist. A `<owner>/homebrew-tap` repository — which would make this
...
`0.1.0rc9`, a prerelease.

| Channel | State |
|---|---|
| Source checkout — `git clone`, `pip install .` | **live** |
| Zipapp built from a checkout | **live** |
| [TestPyPI](https://test.pypi.org/project/nextbrief/) — `pip`, `pipx`, `uv`, `uvx` with an explicit index URL | **live**: `0.1.0rc9`, sdist and wheel |
...
| GitHub release assets — sdist, wheel, `nextbrief.pyz`, `SHA256SUMS` | **live** on [`v0.1.0rc9`](https://github.com/hancheng-ai/nextbrief/releases/tag/v0.1.0rc9), with a build-provenance attestation. Use the tagged URL: `/releases/latest/` skips prereleases |
