...
[中文文档 →](https://github.com/hancheng-ai/nextbrief/blob/v0.2.1/README.zh.md)
...
Details in [Privacy](#privacy) and [SECURITY.md](https://github.com/hancheng-ai/nextbrief/blob/v0.2.1/SECURITY.md).
...
Below is a real run against the [example workspace](https://github.com/hancheng-ai/nextbrief/tree/v0.2.1/examples/workspace) in this
...
[`examples/workspace/state/brief.json`](https://github.com/hancheng-ai/nextbrief/blob/v0.2.1/examples/workspace/state/brief.json) — so
...
`v0.2.1` sdist and checks it against a `sha256` in the stanza — and that digest
...
[`packaging/homebrew/nextbrief.rb`](https://github.com/hancheng-ai/nextbrief/blob/v0.2.1/packaging/homebrew/nextbrief.rb), so it is
...
This repository is its own marketplace — [`.claude-plugin/marketplace.json`](https://github.com/hancheng-ai/nextbrief/blob/v0.2.1/.claude-plugin/marketplace.json)
...
[`tests/test_plugin.py`](https://github.com/hancheng-ai/nextbrief/blob/v0.2.1/tests/test_plugin.py) lints every skill body against
...
Reading it is also the point of [`docs/INVENTORY_SCHEMA.md`](https://github.com/hancheng-ai/nextbrief/blob/v0.2.1/docs/INVENTORY_SCHEMA.md):
...
| GitHub release assets — sdist, wheel, `nextbrief.pyz`, `SHA256SUMS` | **live** on [`v0.2.1`](https://github.com/hancheng-ai/nextbrief/releases/tag/v0.2.1), with a build-provenance attestation. Documented by tag rather than `/releases/latest/`, which resolves to the newest non-prerelease |
...
in the prompt: **[docs/ARCHITECTURE.md](https://github.com/hancheng-ai/nextbrief/blob/v0.2.1/docs/ARCHITECTURE.md)**.
...
See [SECURITY.md](https://github.com/hancheng-ai/nextbrief/blob/v0.2.1/SECURITY.md).

## Release history

Newest first. Every entry links to the full detail in
[CHANGELOG.md](https://github.com/hancheng-ai/nextbrief/blob/v0.2.1/CHANGELOG.md), which is the record; this table is the index.
...
[PRIVACY.md](https://github.com/hancheng-ai/nextbrief/blob/v0.2.1/PRIVACY.md) states the same thing as a policy, in one page: the two
...
Read [CONTRIBUTING.md](https://github.com/hancheng-ai/nextbrief/blob/v0.2.1/CONTRIBUTING.md) first — especially the design contract, the
...
Apache 2.0. See [LICENSE](https://github.com/hancheng-ai/nextbrief/blob/v0.2.1/LICENSE).
