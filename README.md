<p align="center">
  <img src="https://raw.githubusercontent.com/hancheng-ai/nextbrief/v0.4.1/packaging/icon/nextbrief.svg" alt="" width="96" height="96">
</p>
...
[![Release](https://img.shields.io/badge/release-v0.4.1-blue)](https://github.com/hancheng-ai/nextbrief/releases/tag/v0.4.1)
...
[![License: Apache 2.0](https://img.shields.io/badge/license-Apache%202.0-blue.svg)](https://github.com/hancheng-ai/nextbrief/blob/v0.4.1/LICENSE)

**A daily brief across every project you own — where every claim is checked against evidence before it is allowed to print.**

[中文文档 →](https://github.com/hancheng-ai/nextbrief/blob/v0.4.1/README.zh.md)
...
Details in [Privacy](#privacy) and [SECURITY.md](https://github.com/hancheng-ai/nextbrief/blob/v0.4.1/SECURITY.md).
...
Below is a real run against the [example workspace](https://github.com/hancheng-ai/nextbrief/tree/v0.4.1/examples/workspace) in this
...
[`examples/workspace/state/brief.json`](https://github.com/hancheng-ai/nextbrief/blob/v0.4.1/examples/workspace/state/brief.json) — so
...
>
> ```sh
> # 0.4.1 stands in for whichever candidate you mean; there is no "latest"
> # on that index worth asking for
> pipx install --index-url https://test.pypi.org/simple/ "nextbrief==0.4.1"
> ```
>
...
```sh
curl -fsSLO https://github.com/hancheng-ai/nextbrief/releases/download/v0.4.1/nextbrief.pyz
...
```sh
curl -fsSLO https://github.com/hancheng-ai/nextbrief/releases/download/v0.4.1/SHA256SUMS
...
[CONTRIBUTING](https://github.com/hancheng-ai/nextbrief/blob/v0.4.1/CONTRIBUTING.md#windows).
...
This repository is its own marketplace — [`.claude-plugin/marketplace.json`](https://github.com/hancheng-ai/nextbrief/blob/v0.4.1/.claude-plugin/marketplace.json)
...
[`tests/test_plugin.py`](https://github.com/hancheng-ai/nextbrief/blob/v0.4.1/tests/test_plugin.py) lints every skill body against
...
Reading it is also the point of [`docs/INVENTORY_SCHEMA.md`](https://github.com/hancheng-ai/nextbrief/blob/v0.4.1/docs/INVENTORY_SCHEMA.md):
...
| GitHub release assets — sdist, wheel, `nextbrief.pyz`, `SHA256SUMS` | **live** on [`v0.4.1`](https://github.com/hancheng-ai/nextbrief/releases/tag/v0.4.1), with a build-provenance attestation. Documented by tag rather than `/releases/latest/`, which resolves to the newest non-prerelease |
...
in the prompt: **[docs/ARCHITECTURE.md](https://github.com/hancheng-ai/nextbrief/blob/v0.4.1/docs/ARCHITECTURE.md)**.
...
- **Write a terminal status.** `done`, `dropped` and `deferred` all take an item off
  the page, and no agent may write one — see [the design contract](https://github.com/hancheng-ai/nextbrief/blob/v0.4.1/CONTRIBUTING.md).
...
See [SECURITY.md](https://github.com/hancheng-ai/nextbrief/blob/v0.4.1/SECURITY.md).
...
[CHANGELOG.md](https://github.com/hancheng-ai/nextbrief/blob/v0.4.1/CHANGELOG.md), which is the record; this table is the index.
...
2. **Check `schema_version` first, and stop rather than guess if it is not a
   ...
   [`docs/INVENTORY_SCHEMA.md`](https://github.com/hancheng-ai/nextbrief/blob/v0.4.1/docs/INVENTORY_SCHEMA.md).
...
[PRIVACY.md](https://github.com/hancheng-ai/nextbrief/blob/v0.4.1/PRIVACY.md) states the same thing as a policy, in one page: the two
...
Read [CONTRIBUTING.md](https://github.com/hancheng-ai/nextbrief/blob/v0.4.1/CONTRIBUTING.md) first — especially the design contract, the
...
Apache 2.0. See [LICENSE](https://github.com/hancheng-ai/nextbrief/blob/v0.4.1/LICENSE).
