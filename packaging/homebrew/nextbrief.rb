...
class Nextbrief < Formula
  ...
  url "https://github.com/hancheng-ai/nextbrief/releases/download/v0.1.0rc10/nextbrief-0.1.0rc10.tar.gz"
  # Declared rather than inferred from the filename: `0.1.0rc10` is exactly the
  ...
  version "0.1.0rc10"
  sha256 "20a3414fa7a52ec5fbf378aef8a8662d79180d345bbbf635d8096e0da4c91e2c"
  license "Apache-2.0"
