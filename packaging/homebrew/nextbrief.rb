...
class Nextbrief < Formula
  ...
  url "https://github.com/hancheng-ai/nextbrief/releases/download/v0.4.2/nextbrief-0.4.2.tar.gz"
  # Declared rather than inferred from the filename: `0.4.2` is exactly the
