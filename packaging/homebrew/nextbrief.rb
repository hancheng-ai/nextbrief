...
class Nextbrief < Formula
  ...
  url "https://github.com/hancheng-ai/nextbrief/releases/download/v0.1.0rc3/nextbrief-0.1.0rc3.tar.gz"
  # Declared rather than inferred from the filename: `0.1.0rc3` is exactly the
