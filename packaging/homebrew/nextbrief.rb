...
class Nextbrief < Formula
  ...
  url "https://github.com/hancheng-ai/nextbrief/releases/download/v0.4.0/nextbrief-0.4.0.tar.gz"
  # Declared rather than inferred from the filename: `0.4.0` is exactly the
  ...
  sha256 "953b01169bb5d86689f60b80b6e7d46eb6924d3096a98fcbde2b42db352dee26"
  license "Apache-2.0"
