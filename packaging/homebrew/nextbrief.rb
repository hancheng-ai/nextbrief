...
class Nextbrief < Formula
  ...
  url "https://github.com/hancheng-ai/nextbrief/releases/download/v0.1.0rc7/nextbrief-0.1.0rc7.tar.gz"
  # Declared rather than inferred from the filename: `0.1.0rc7` is exactly the
