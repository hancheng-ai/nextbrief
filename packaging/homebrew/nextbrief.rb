...
class Nextbrief < Formula
  ...
  url "https://github.com/hancheng-ai/nextbrief/releases/download/v0.4.1rc1/nextbrief-0.4.1rc1.tar.gz"
  # Declared rather than inferred from the filename: `0.4.1rc1` is exactly the
  ...
  sha256 "df2c20a43af7a2b4859c45091c848dd2ea81574baae6b59d44d7830b43475b38"
  license "Apache-2.0"
