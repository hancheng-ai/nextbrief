...
class Nextbrief < Formula
  ...
  url "https://github.com/hancheng-ai/nextbrief/releases/download/v0.4.1/nextbrief-0.4.1.tar.gz"
  # Declared rather than inferred from the filename: `0.4.1` is exactly the
